...
class AssignmentDoubleController extends Controller
{
    /**
     * Display the assignment list for the active Double (A Vs B) session.
     */
    public function index()
    {
        ...
        if (!$activeSessionId) {
            ...
            return view('double_mode.assignments', compact('error', 'assignments', 'stats', 'activeSessionId'));
        }

        // Validate session exists and is Double mode
