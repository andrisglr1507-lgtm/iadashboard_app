...
@section('title', 'Monitoring Assignment')
@section('page_title', 'Monitoring Assignment')
                    ...
                    @empty
                        <tr>
                            <td colspan="13" class="text-center" style="padding: 60px 24px; color: #94a3b8;">
                                ...
                                <p style="font-size: 0.8rem;">Assignment akan muncul setelah user di-assign pada halaman Recount.</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
